...
int TestCpuEnv(int cpu_info) {
  ...
  if (TestEnv("LIBYUV_DISABLE_MSA")) {
    cpu_info &= ~codec.camera::kCpuHasMSA;
  }
#endif
  ...
  if (TestEnv("LIBYUV_DISABLE_X86")) {
    cpu_info &= ~codec.camera::kCpuHasX86;
  }
  if (TestEnv("LIBYUV_DISABLE_SSE2")) {
    cpu_info &= ~codec.camera::kCpuHasSSE2;
  }
  if (TestEnv("LIBYUV_DISABLE_SSSE3")) {
    cpu_info &= ~codec.camera::kCpuHasSSSE3;
  }
  if (TestEnv("LIBYUV_DISABLE_SSE41")) {
    cpu_info &= ~codec.camera::kCpuHasSSE41;
  }
  if (TestEnv("LIBYUV_DISABLE_SSE42")) {
    cpu_info &= ~codec.camera::kCpuHasSSE42;
  }
  if (TestEnv("LIBYUV_DISABLE_AVX")) {
    cpu_info &= ~codec.camera::kCpuHasAVX;
  }
  if (TestEnv("LIBYUV_DISABLE_AVX2")) {
    cpu_info &= ~codec.camera::kCpuHasAVX2;
  }
  if (TestEnv("LIBYUV_DISABLE_ERMS")) {
    cpu_info &= ~codec.camera::kCpuHasERMS;
  }
  if (TestEnv("LIBYUV_DISABLE_FMA3")) {
    cpu_info &= ~codec.camera::kCpuHasFMA3;
  }
  if (TestEnv("LIBYUV_DISABLE_F16C")) {
    cpu_info &= ~codec.camera::kCpuHasF16C;
  }
  if (TestEnv("LIBYUV_DISABLE_AVX512BW")) {
    cpu_info &= ~codec.camera::kCpuHasAVX512BW;
  }
  if (TestEnv("LIBYUV_DISABLE_AVX512VL")) {
    cpu_info &= ~codec.camera::kCpuHasAVX512VL;
  }
  if (TestEnv("LIBYUV_DISABLE_AVX512VBMI")) {
    cpu_info &= ~codec.camera::kCpuHasAVX512VBMI;
  }
  if (TestEnv("LIBYUV_DISABLE_AVX512VBMI2")) {
    cpu_info &= ~codec.camera::kCpuHasAVX512VBMI2;
  }
  if (TestEnv("LIBYUV_DISABLE_AVX512VBITALG")) {
    cpu_info &= ~codec.camera::kCpuHasAVX512VBITALG;
  }
  if (TestEnv("LIBYUV_DISABLE_AVX512VPOPCNTDQ")) {
    cpu_info &= ~codec.camera::kCpuHasAVX512VPOPCNTDQ;
  }
  if (TestEnv("LIBYUV_DISABLE_GFNI")) {
    cpu_info &= ~codec.camera::kCpuHasGFNI;
  }
#endif
